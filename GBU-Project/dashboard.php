...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-mini sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed main-content-boxed">
                ...
                <div class="content-header content-header-fullrow">
                    <div class="content-header-section align-parent">
                        ...
                        <div class="content-header-item">
                            ...
                            <a class="align-middle link-effect font-w600" href="javascript:void(0)">Admin Dashboard</a>
                        </div>
                        <!-- END User Info -->
                    </div>
                </div>
            ...
            //         $sql = "SELECT id,type FROM accounts WHERE email = :email";
            ...
            //             if ($type == 'Admin'){
                        ...
                        <ul class="nav-main">
                            ...
                            <li>
                                <a href=""><i class="si si-shield"></i><span class="sidebar-mini-hide">Activities</span></a>
                            </li>
                            <li class="nav-main-heading"><span class="sidebar-mini-visible">ST</span><span class="sidebar-mini-hidden">Settings</span></li>
                            <li>
                                <a href="GBU-memberform.php"><i class="si si-user"></i><span class="sidebar-mini-hide">Add New Member</span></a>
                            </li>
                            <li>
                                <a href="Cell-update.php"><i class="si si-user"></i><span class="sidebar-mini-hide">Add New Cell</span></a>
                            </li>
            ...
            <header id="page-header">
                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section">
                        ...
                        <div class="dropdown d-inline-block" role="group">
                            ...
                            <div class="dropdown-menu min-width-200" aria-labelledby="page-header-user-dropdown">
                                ...
                                <a class="dropdown-item" href="Add-account.php">
                                    <i class="si si-note mr-5"></i> Add Account
                                </a>
                                ...
                                <!-- END Side Overlay -->
                                <a class="dropdown-item" href="Treasurer/dashboard.php" >
                                    <i class="si si-wrench mr-5"></i>Treasurer
                                </a>
                                <a class="dropdown-item" href="Secretary/dashboard.php"  >
                                    <i class="si si-wrench mr-5"></i> Secretary
                                </a>
                    ...
                    <!-- END Left Section -->
                          <div class="content-header-item">
                                <a class="link-effect font-w700" href="javascript:void(0)" style="text-decoration: none;">
                                    <i class="si si- text-primary"></i>
                ...
                <div class="content content-full">
                            ...
                            <a class="block block-link-pop text-right bg-corporate" href="javascript:void(0)">
                                <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                                    <div class="float-left mt-10 d-none d-sm-block">
                                        <i class="si si-users fa-3x text-corporate-light"></i>
                                    </div>
                                    <div class="font-size-h3 font-w600 text-white" data-toggle="countTo" data-speed="1000" data-to="<?php echo htmlentities($cnt);?>">0</div>
                                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Members</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-xl-3">
                      ...
                      $cnt=$query->rowCount();
                            ...
                            <a class="block block-link-pop text-right bg-earth" href="javascript:void(0)">
                                <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                                    <div class="float-left mt-10 d-none d-sm-block">
                                        <i class="si si-users fa-3x text-earth-light"></i>
                                    </div>
                                    <div class="font-size-h3 font-w600 text-white"><span data-toggle="countTo" data-speed="1000" data-to="<?php echo htmlentities($cnt);?>">0</span></div>
                                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Cells</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-xl-3">
                      ...
                      $cnt=$query->rowCount();
                            ...
                            <a class="block block-link-rotate block-transparent text-right bg-primary-lighter" href="javascript:void(0)">
                                <div class="block-content block-content-full clearfix">
                                    ...
                                    <div class="font-size-h3 font-w600 text-white" data-toggle="countTo" data-speed="1000" data-to="<?php echo htmlentities($cnt);?>">0</div>
                                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Departments</div>
                                </div>
                            </a>
                        </div>
                    </div>
                            ...
                            <a class="block block-rounded block-bordered block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="py-20 text-center">
                                        <div class="mb-10">
                                            <i class="fa fa-envelope fa-3x text-corporate"></i>
                                        </div>
                                        <div class="font-size-h4 font-w600">50 Messages</div>
                            ...
                            <a class="block block-rounded block-bordered block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-h4 font-w600">60 Acitiies</div>
                        ...
                        <div class="col-md-4">
                            <a class="block block-rounded block-bordered block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                     <?php 
                include_once('config/PDO.php');
                      $sql = "SELECT offerings from income";
                      $query = $db->prepare($sql);
                      $query->execute();
                      $results=$query->fetchAll(PDO::FETCH_OBJ);
                      $cnt=$query->rowCount();
                                ?>
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-h4 font-w600"><?php echo htmlentities($cnt);?> Rfw</div>
                                        <div class="text-muted">UGBR Contribution</div>
                                    </div>

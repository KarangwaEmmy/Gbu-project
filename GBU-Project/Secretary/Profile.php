...
<html lang="en" class="no-focus">
    ...
    <body>
                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section d-none d-lg-block">
                        ...
                        <ul class="nav-main-header">
                            <li>
                                <a class="active" href="#"><i class="si"></i>My Profile page</a>
                            </li>
        ...
        <button type="submit" class="btn btn-primary"><a href="GUB-memberform.html" style="color: white">Update Info</a> </button>
   </div>

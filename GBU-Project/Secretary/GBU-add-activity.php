...
session_start();
    ...
    $sql = "INSERT INTO `activities` (`name`, `person`, `details`) VALUES ('$name', '$person', '$activity')";
    $stmt= $db->prepare($sql);

    $stmt->execute(array(':name'=>$name, ':person'=>$person,':activity'=>$activity));

    if ($stmt) {
        echo "<script>alert( 'Activity was created  Successfully!')</script>";
    }
            ...
            <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Write activity</h3>
                        ...
                        <div class="block-content">
                            <form action="" method="post">
                                <div class="form-group row">
                                    <div class="col-12">
                                        <div class="form-material form-material-primary input-group">
                                            <input type="text" class="form-control" id="message-email" name="name" placeholder="Write a title?">
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        <div class="form-material form-material-primary input-group">
                                            <input type="text" class="form-control" id="message-subject" name="person" placeholder="What is this Person?">
                                 ...
                                 <div class="form-group row">
                                    <div class="col-12">
                                        <!-- SimpleMDE Container -->
                                        <textarea class="js-summernote" id="js-summernote-air" name="activity">Activity!</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="submit" class="btn btn-alt-primary" data-dismiss="modal">
                                        <i class="fa fa-send mr-5"></i> Save Activity
                                    </button>

            ...
            <header id="page-header">
                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section">
                        <!-- Logo -->
                        <div class="content-header-item">
                            <a class="link-effect font-w700 mr-5" href="dashboard.php">
                                <i class="si si-fire text-primary"></i>
                                <span class="font-size-xl text-dual-primary-dark">GBU</span><span class="font-size-xl text-primary">Nyarugenge Campus</span>
                            </a>
                        </div>
                    ...
                    <div class="content-header-section d-none d-lg-block">
                        ...
                        <ul class="nav-main-header">
                            <li>
                                <a class="active" href="bd_dashboard.php"><i class="si"></i>Gbu Profile page</a>
                            </li>
                  
                            <li>
                                <a href="bd_search.php"><i class="si si-magnifier"></i>Search</a>
                            </li>

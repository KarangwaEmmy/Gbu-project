...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Income | GBU Nyarugenge Campus</title>
                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section d-none d-lg-block">
                        ...
                        <ul class="nav-main-header">
                            <li>
                                <a class="active" href="javascript:void(0)"><i class="si"></i>GBU  Income</a>
                            </li>
                  
                            <li>
                                <button type="button"    ><a href="Add-income.php" style="text-decoration: none;color: #000;">Add Income</a></button>
                            </li>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">  Total Income Table <small> </small></h3>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell">Offering</th>
                                        <th class="d-none d-sm-table-cell">Tithe</th>
                                        <th class="d-none d-sm-table-cell">Praise</th>
                      ...
                      $sql = "SELECT id,date,offerings,tithe,thankgiving,comment,(offerings+tithe+thankgiving) as total from income";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                             <?=$result->date?>                       </td>
                                        <td class="d-none d-sm-table-cell">
                                            <a href="javascript:void(0)"><?=$result->offerings?> </a>
                                        </td>
                                        <td class="d-none d-sm-table-cell">
                                             <?=$result->tithe?>  
                                        </td>
                                        <td class="text-right">
                                            <span class="text-black"><?=$result->thankgiving?></span>
                                        </td>
                                         <td class="d-none d-sm-table-cell">
                                            <a href="#"><?=$result->total?></a>
                                        </td>
                                         <td class="d-none d-sm-table-cell">

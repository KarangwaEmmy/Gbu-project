<?php
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        $donor = filter_var($_POST['donor'], FILTER_SANITIZE_STRING);
        ...
        $sql = $db->prepare("INSERT INTO `donation` (`academic`,`date`, `donor`, `amount`, `comment`) VALUES ('$academic','$date', '$donor', '$amount', '$comment')");

        $sql->execute(array('academic'=>$academic, ':date'=>$date, ':donor'=>$donor, ':amount'=>$amount,':comment'=>$comment));
        if ($sql) {
              echo "<script>alert( 'Donation was created  Successfully!')</script>";
        }else{
              echo "<script>alert( 'Error in creating  Donation!')</script>";
        }
        $date = "";
        unset($sql);
    }
        ...
        <div id="page-container" class="sidebar-inverse side-scroll page-header-fixed page-header-inverse main-content-boxed">
                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section d-none d-lg-block">
                        ...
                        <ul class="nav-main-header">
                            <li>
                                <a class="active" href="#"><i class="si"></i>GBU Donation Form</a>
                            </li>
            ...
            <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title" style="text-align: center;">GBU Donation Form</h3>
                      ...
                      if($query->rowCount() > 0)
                        ...
                        {               
                                ...
                                ?> 
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">Donation <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="val-digits" name="amount" placeholder="eg. 7900 Rfw" required="">
                                            </div>
                                        </div>
                                    <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val- ">Donor   <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="val" name="donor" placeholder="Enter a Donor.." required="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <button type="submit" name="submit" class="btn btn-alt-primary">
                                            <i class="fa fa-check mr-5"></i> Submit Donation
                                        </button>
                                    </div>
                                </div>

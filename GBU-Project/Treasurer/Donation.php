<?php
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        $sql = $db->prepare("INSERT INTO `donation` (`date`, `donor`, `amount`, `comment`) VALUES ('$date', '$donor', '$amount', '$comment')");

        $sql->execute(array(':date'=>$date, ':donor'=>$donor, ':amount'=>$amount,':comment'=>$comment));
        if ($sql) {

                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section d-none d-lg-block">
                        ...
                        <ul class="nav-main-header">
                            <li>
                                <a class="active" href="javascript.void(0)"><i class="si"></i>GBU  Total Expenses</a>
                            </li>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">  Total Expenses    </h3>
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <thead>
                                    <tr>
                                        <th>NO</th>
                                        <th style="width: 100px;">Reasurer Name</th>
                                        <th class="d-none d-sm-table-cell">Submitted date</th>
                                        <th class="d-none d-sm-table-cell">Expense Name</th>
                                ...
                                ?>
                                    <tr> 
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                            <?=$result->submitter?>                        </td>
                                        <td class="d-none d-sm-table-cell">
                                            <a href="javascript:void(0)"><?=$result->date?></a>
                                        </td>
                                        <td class="d-none d-sm-table-cell">

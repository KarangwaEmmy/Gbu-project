                    ...
                    <div class="content-header-section">
                        ...
                        <div class="content-header-item">
                            <a class="link-effect font-w700 mr-5" href="#">
                                <i class="si si-users text-primary"></i>
                                <span class="font-size-xl text-dual-primary-dark">Reset Password</span>
                            </a>
                        </div>
                        <!-- END Logo -->
                    </div>
                        ...
                        <div class="hero-static col-lg-6 col-xl-4">
                            <div class="content content-full overflow-hidden">
                                ...
                                <div class="py-30 text-center">
                                    ...
                                    <h1 class="h4 font-w700 mt-30 mb-10">Please enter your   email, to reset</h1>
                                ...
                                <form class="js-validation-reminder" action="be_pages_auth_all.php" method="post">
                                    <div class="block block-themed block-rounded block-shadow">
                                        <div class="block-header bg-gd-primary" style="height: 30px;">
                                            ...
                                            <div class="block-options">
                                                ...
                                                <span class="text-white"><i class="si si-wrench" style="background-color: transparent;"></i> </span>
                                </a>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="block-content">
                                            ...
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-alt-primary">
                                                    <i class="fa fa-asterisk mr-10"></i>Reset My Password  
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">
                                <i class="si si-wallet text-info mr-5"></i>Tips for Account Recovery
                            </h3>
                            <div class="block-options">
                        ...
                        <div class="block-content">
                        <h3>If your account is not reset follow the following</h3>
                        <ol>
                            <li>Use the email you used during registation</li>
                            <li>Cont Admin...</li>
                        </ol>
                        </div>
                    </div>

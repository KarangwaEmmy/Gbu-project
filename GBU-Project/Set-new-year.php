...
<html lang="en" class="no-focus">
    ...
    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title" style="text-align: center;">GBU Nyarugenge Campus- Setting New Academic Year</h3>
                                ...
                                <div class="col-xl-6">
                                    <form class="js-validation-bootstrap" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-select2">Set New Academic Year <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-select2"> New Semester <span class="text-danger">*</span></label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" name="submit" class="btn btn-alt-primary">Save New changes</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
